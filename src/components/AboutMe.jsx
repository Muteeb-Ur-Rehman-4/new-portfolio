...
const AboutMe = () => {
  return (
    <motion.div initial={{ opacity: 0 }}
      ...
      <div className="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col justify-around lg:items-start md:items-center sm:items-center mt-5 lg:w-[85vw] md:w-[55vw] sm:w-[60vw] ">
        ...
        <div className='group flex flex-col justify-around w-full lg:w-[50vw] xs:w-[60vw] max-h-[20rem] m-10 rounded-xl bg-white/20 shadow-lg ring-1 ring-black/5 p-3 transition-transform duration-300'>
          <div className='flex flex-col items-center'>
